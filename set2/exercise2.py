...
def set2exersise2(): # this is semi-right
    ...
    wordArray[0] = wordArray[0].upper() #these functions make the first,second and fourth letter output to be uppercase
    #i.e WordArray[0] would be getting the 13th letter in the imported string, and making it upper case m->M
